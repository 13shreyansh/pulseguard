...
Use this flow for screenshots, video capture, or a live walkthrough.
...
1. Open Pulse and show the first screen.
2. Point out the immediate `Do this now` guidance before pressing anything.
...
- Start screen with immediate safety guidance.
- Listening or typed-report state with location indicator.
- Transcript confirmation screen.
- `Do this now` guidance with do / don't / watch sections.
- Nearby emergency care card.
- Final help-status screen.
